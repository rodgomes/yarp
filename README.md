...
```
{
  ...
  "routers" : [
    ...
    //this is an example without any path matching
    {
...
The routers are evaluated from top to bottom and the first match will be returned. 

PS: the current implementation throws an error if no router is found
